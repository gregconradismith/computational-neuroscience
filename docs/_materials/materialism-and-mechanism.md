...
<!-- wp:list-item -->
<li><strong><strong>Notebook/Blackboard Writing Prompt</strong></strong>s<!-- wp:list -->
<ul class="wp-block-list"><!-- wp:list-item -->
...
<!-- wp:image {"id":3757,"width":"369px","height":"auto","sizeSlug":"large","linkDestination":"none","align":"center"} -->
